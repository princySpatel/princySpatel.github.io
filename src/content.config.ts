...
const configuration = defineCollection({
  ...
  schema: z.object({
    ...
    personal: z.object({
      ...
      leetcodeProfile: z.url().optional(),
    ...
    menu: z.object({
      ...
      Playground: z.string().default("/blog"),
...
const blog = defineCollection({
  ...
  schema: z
    .object({
      // Add this line inside your schema definitions for both 'project' and 'blog' collections:
